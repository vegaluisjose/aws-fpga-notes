...
If you do not already have an Amazon Web Services (AWS) account,

* Create a regular one [here](https://aws.amazon.com)

or

* Create a student one [here](https://aws.amazon.com/education/awseducate/apply/)
